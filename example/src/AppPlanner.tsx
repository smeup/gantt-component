...
import { GanttPlannerProps } from "../../dist/components/planner/planner";
...
const mockDataDetails: GanttPlannerProps = {
  items: [
    {
      id: "00152",
      name: "BERARDI        MARCELLO",
      type: "timeline",
      valuesToShow: [],
      schedule: [],
    },
