...
## Interactive Gantt Chart in TypeScript.
...
```
npm install "@sme.up/gantt-component"
```

## How to use it

```javascript
import { Gantt, Task, EventOption, StylingOption, ViewMode, DisplayOption } from '@sme.up/gantt-component';
